...
<div id="wrapper">
    <div class="content">
        <?php if (isset($member)) { ?>
        <?php $this->load->view('admin/companies/staff/stats'); ?>
        <div class="member">
                    ...
                    <div class="panel-body ">
                        ...
                        <div class="tab-content tw-mt-5">
                            ...
                            <div role="tabpanel" class="tab-pane" id="staff_permissions">
                                <?php
                                    hooks()->do_action('company_render_permissions');
                                    $dr = get_option('default_company_role');

                                    foreach ($roles as $key => $role) {
                                        if (get_option('default_company_role') !== $role['roleid']) {
                                            unset($roles[$key]);
                                        }
                                    }
                                    ...
                                    foreach ($roles as $role) {
                                        if (isset($member)) {
                                            ...
                                            if ($default_company_role == $role['roleid']) {
                                                $selected = $role['roleid'];
                                            }
                                        }
                                    }
                                ...
                                <?php
                                     ...
                                     $this->load->view('admin/companies/staff/permissions', $permissionsData);
                                 ?>
                            </div>
                        </div>
                    </div>
                           ...
                           foreach ($timesheets as $t) { ?>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td align="right"><?php echo '<b>' . _l('total_by_hourly_rate') . ':</b> '; ?>
                                    </td>
                                    <td align="right">
